...
int __write_executable(const char* source_code, int source_code_len, char** out_binary, int* out_binary_len) {
    ks_engine* ks;
...
int compile(char* input_file, char* output_file) {
    ...
    if (__write_executable(source_code, source_code_len, &p, &file_len) != 0) {
